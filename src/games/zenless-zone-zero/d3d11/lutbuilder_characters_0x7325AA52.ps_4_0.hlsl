...
// used on characters??
// ---- Created with 3Dmigoto v1.4.1 on Wed Oct 15 08:07:54 2025
...
void main(
  ...
  renodx::lut::Config lut_config = renodx::lut::config::Create(
      s2_s,
      cb0[165].w * injectedData.colorGradeLUTStrength,
      injectedData.colorGradeLUTScaling,
      renodx::lut::config::type::SRGB,
      renodx::lut::config::type::SRGB,
      cb0[165].xyz  // precompute
  );
  r1.xyz = cb0[184].xxx * r0.xyz;
  r2.xyzw = cmp(r1.xxyy < cb0[184].yzyz);
  r3.xyzw = r2.yyyy ? cb0[187].xyzw : cb0[189].xyzw;
  r4.xyzw = r2.yyww ? cb0[188].xyxy : cb0[190].xyxy;
  r3.xyzw = r2.xxxx ? cb0[185].xyzw : r3.xyzw;
  r4.xyzw = r2.xxzz ? cb0[186].xyxy : r4.xyzw;
  r0.x = r0.x * cb0[184].x + -r3.x;
  r0.x = r0.x * r3.z;
  r0.w = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.y * r0.x;
  ...
  r0.x = r0.w ? r0.x : 0;
  r3.x = r0.x * r3.w + r3.y;
  r5.xyzw = r2.wwww ? cb0[187].xyzw : cb0[189].xyzw;
  r2.xyzw = r2.zzzz ? cb0[185].xyzw : r5.xyzw;
  r0.x = r0.y * cb0[184].x + -r2.x;
  r0.x = r0.x * r2.z;
  r0.y = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.w * r0.x;
  ...
  r0.x = r0.y ? r0.x : 0;
  r3.y = r0.x * r2.w + r2.y;
  r0.xy = cmp(r1.zz < cb0[184].yz);
  r1.xyzw = r0.yyyy ? cb0[187].xyzw : cb0[189].xyzw;
  r0.yw = r0.yy ? cb0[188].xy : cb0[190].xy;
  r1.xyzw = r0.xxxx ? cb0[185].xyzw : r1.xyzw;
  r0.xy = r0.xx ? cb0[186].xy : r0.yw;
  r0.z = r0.z * cb0[184].x + -r1.x;
  r0.z = r0.z * r1.z;
  r0.w = cmp(0 < r0.z);
  r0.z = log2(r0.z);
  r0.y = r0.y * r0.z;
...
/* Original LUT Sampling*/
  ...
  if (r0.x != 0) {
    ...
    r1.xyz = cb0[165].zzz * r0.zxy;
    r0.w = floor(r1.x);
    r1.xw = float2(0.5, 0.5) * cb0[165].xy;
    r1.yz = r1.yz * cb0[165].xy + r1.xw;
    r1.x = r0.w * cb0[165].y + r1.y;
    r2.xyzw = t1.SampleLevel(s2_s, r1.xz, 0).xyzw;
    r4.x = cb0[165].y;
    r4.y = 0;
    r1.xy = r4.xy + r1.xz;
    r1.xyzw = t1.SampleLevel(s2_s, r1.xy, 0).xyzw;
    r0.w = r0.z * cb0[165].z + -r0.w;
  ...
  o0.xyz = saturate(r0.xzw * cb0[190].zzz + r0.yyy);
  o0.w = 1;
  return;
}
