  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t10.Sample(s8_s, r1.yz).xyzw;
  ...
  r6.xy = float2(-0.333333343,-0.333333343) * r2.zw;
  ...
  if (r1.w != 0) {
    ...
    r2.w = r1.w + r1.w;
    r2.w = cmp(r2.w >= -r2.w);
    r5.xw = r2.ww ? float2(2,0.5) : float2(-2,-0.5);
    r1.w = r5.w * r1.w;
    r1.w = frac(r1.w);
    r2.w = r5.x * r1.w;
    r4.x = cmp(1 < r2.w);
    ...
    r8.xyzw = t4.Sample(s3_s, r6.xy).xyzw;
    r6.xyz = log2(abs(r8.xyz));
    r6.xyz = float3(0.333333343,0.333333343,0.333333343) * r6.xyz;
    r6.xyz = exp2(r6.xyz);
    r6.xyz = r6.xyz * float3(1.49380159,1.49380159,1.49380159) + -r8.xyz;
    r7.yzw = cmp(r8.xyz >= float3(0.300000012,0.300000012,0.300000012));
    r7.yzw = r7.yzw ? float3(1,1,1) : 0;
    r6.xyz = float3(-0.699999988,-0.699999988,-0.699999988) + r6.xyz;
    r6.xyz = r7.yzw * r6.xyz + r8.xyz;
    ...
    r7.yzw = r6.www * r7.yzw + r6.xyz;
    r7.yzw = r2.www ? r7.yzw : r6.xyz;
    if (r5.z != 0) {
      r5.xz = r3.xy * cb1[20].xy + cb1[20].zw;
      r8.xyzw = t5.Sample(s0_s, r5.xz).xyzw;
      r5.xzw = cb1[21].yyy * r8.xyz;
      r7.yzw = r5.xzw * r6.xyz + r7.yzw;
    }
    r2.xyz = r7.yzw + r2.xyz;
    r1.w = r7.y + r7.z;
    r1.w = r1.w + r7.w;
    o0.w = saturate(r1.w * 0.333299994 + r6.w);
  } else {
    r2.x = r7.x;
    r2.y = r5.y;
    o0.w = r6.w;
  ...
  r2.xyz = renodx::lut::Sample(t2, lut_config, untonemapped);

  /*
  r2.xyz = r2.zxy * float3(5.55555582,5.55555582,5.55555582) + float3(0.0479959995,0.0479959995,0.0479959995);
  r2.xyz = log2(r2.xyz);
  r2.xyz = saturate(r2.xyz * float3(0.0734997839,0.0734997839,0.0734997839) + float3(0.386036009,0.386036009,0.386036009));
  r2.yzw = cb1[0].zzz * r2.xyz;
  r1.w = floor(r2.y);
  r3.xy = float2(0.5,0.5) * cb1[0].xy;
  r5.yz = r2.zw * cb1[0].xy + r3.xy;
  r5.x = r1.w * cb1[0].y + r5.y;
  r6.xyzw = t2.SampleLevel(s0_s, r5.xz, 0).xyzw;
  r3.z = cb1[0].y;
  r2.yz = r5.xz + r3.zw;
  r3.xyzw = t2.SampleLevel(s0_s, r2.yz, 0).xyzw;
  r1.w = r2.x * cb1[0].z + -r1.w;
  ...
  */
  ...
  r5.xy = r0.xx * cb2[11].xy + cb3[0].zw;
  r5.zw = float2(-0.5,-0.5) + v1.xy;
  r3.z = cb0[137].x * cb0[137].w;
  r3.zw = r5.zw * r3.zw + float2(0.5,0.5);
  x0[0].xy = r3.zw;
  x0[1].xy = r3.xy;
  x0[2].xy = v1.xy;
  r0.w = round(cb2[6].z);
  ...
  r5.xy = r6.xy + r5.xy;
  r5.xyzw = r5.xyzw + r1.yzyz;
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t9.Sample(s7_s, r5.xy).xyzw;
  ...
  r2.w = min(2, (int)r2.w);
  r5.xy = x2[r2.w+0].xy;
  r5.xy = cb2[2].xy * r5.xy;
  r5.xy = r5.xy * r1.ww + cb2[2].zw;
  r5.xy = r0.xx * cb2[6].xy + r5.xy;
  r5.xy = r0.ww * cb2[13].yy + r5.xy;
  r5.xy = r5.xy + r1.yz;
  x3[0].xy = r3.zw;
  x3[1].xy = r3.xy;
  x3[2].xy = v1.xy;
  ...
  r3.xyzw = t6.Sample(s4_s, r5.xy).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t7.Sample(s5_s, r5.zw).xyzw;
