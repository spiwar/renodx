...
// ---- Created with 3Dmigoto v1.4.1 on Sat Jan 11 04:15:47 2025
...
void main(
  ...
  r6.xy = r1.zw * r4.zz;
  r2.xy = r2.xy + r0.xy;
  r2.xy = r3.yy * r4.xy + r2.xy;
  r8.xyzw = t1.Sample(s0_s, r2.xy).xyzw;
  r2.xy = r2.zw + r0.xy;
  r2.xy = r3.zz * r4.xy + r2.xy;
  r1.zw = r1.zw * r4.zz + r2.xy;
  ...
  r6.xyzw = t9.Sample(s1_s, r0.zw).xyzw;
