  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = cmp(0.5 < cb0[160].x);
  if (r0.w != 0) {
    r0.w = cb0[161].y * cb0[159].w;
    ...
    r2.yzw = cb0[159].zzz * r2.xyz;
    r0.w = floor(r2.y);
    r3.xy = float2(0.5,0.5) * cb0[159].xy;
    r3.yz = r2.zw * cb0[159].xy + r3.xy;
    r3.x = r0.w * cb0[159].y + r3.y;
    r4.xyzw = t0.SampleLevel(s0_s, r3.xz, 0).xyzw;
    r5.x = cb0[159].y;
    r5.y = 0;
    r2.yz = r5.xy + r3.xz;
    r3.xyzw = t0.SampleLevel(s0_s, r2.yz, 0).xyzw;
    r0.w = r2.x * cb0[159].z + -r0.w;
