...
// used on character ults?
// ---- Created with 3Dmigoto v1.4.1 on Fri Jan 10 20:50:34 2025
...
void main(
  ...
  r7.xyzw = t8.Sample(s1_s, r0.zw).xyzw;
  r2.xzw = float3(12, 12, 12) * r7.xyz;
  r0.z = 25 * cb0[14].x;
  r0.z = frac(r0.z);
  r0.w = 1 + -v1.y;
  r0.z = r0.z + -r0.w;
