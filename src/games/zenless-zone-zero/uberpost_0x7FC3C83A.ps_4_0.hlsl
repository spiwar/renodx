...
void main(
  ...
  r3.x = 0.5;
  r3.xyzw = t3.Sample(s3_s, r3.xy).yzxw;
  r1.x = r4.w * r4.w;
  r1.x = r4.w * r1.x;
  ...
  if (r0.z != 0) {
    ...
    r2.xzw = log2(abs(r3.xyz));
    r2.xzw = float3(0.333333343, 0.333333343, 0.333333343) * r2.xzw;
    r2.xzw = exp2(r2.xzw);
    r2.xzw = r2.xzw * float3(1.49380159, 1.49380159, 1.49380159) + -r3.xyz;
    r4.xyz = cmp(r3.xyz >= float3(0.300000012, 0.300000012, 0.300000012));
    r4.xyz = r4.xyz ? float3(1, 1, 1) : 0;
    r2.xzw = float3(-0.699999988, -0.699999988, -0.699999988) + r2.xzw;
    r2.xzw = r4.xyz * r2.xzw + r3.xyz;
    r2.xzw = cb1[21].xxx * r2.xzw;
    r0.z = dot(r1.xyz, float3(0.298999995, 0.587000012, 0.114));
    r0.w = cmp(0.5 < cb1[22].x);
    r3.xyz = r0.zzz * r2.xzw + -r2.xzw;
    r3.xyz = r4.www * r3.xyz + r2.xzw;
    r3.xyz = r0.www ? r3.xyz : r2.xzw;
    if (r2.y != 0) {
      r0.zw = r0.xy * cb1[20].xy + cb1[20].zw;
      r5.xyzw = t6.Sample(s0_s, r0.zw).xyzw;
      r4.xyz = cb1[21].yyy * r5.xyz;
      r3.xyz = r4.xyz * r2.xzw + r3.xyz;
    }
  ...
  r1.xyz = renodx::tonemap::config::Apply(untonemapped, config);
